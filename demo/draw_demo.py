...
@file: draw_demo.py
@author: zj
@description: Plot and compare the test results
"""
...
def draw(src_img_list, rotate_img_list, res_img_list):
    ...
    plt.suptitle('src-transforms-res')
    ...
    plt.savefig('./demo/demo.png', bbox_inches='tight')
    plt.show()
...
if __name__ == '__main__':
    ...
    for img_path in rotate_img_list:
        idx = os.path.splitext(os.path.split(img_path)[1])[0].split('-')[0]
